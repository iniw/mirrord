...
impl EnvKey {
    ...
    pub fn autogenerate_with_marker() -> String {
        format!("{}{}", Self::AUTOGENERATED_MARKER, uuid::Uuid::new_v4())
    }
}
...
impl MirrordConfig for EnvKeyFileConfig {
    ...
    fn generate_config(self, context: &mut ConfigContext) -> Result<Self::Generated> {
        ...
        let key = key_from_env
            ...
            .unwrap_or_else(|| EnvKey::Generated(EnvKey::autogenerate()));
